    ...
    partial class BehaviorDb
    {
        ...
        .Init("Cupcake",
            ...
            new Threshold(0.01,
                ...
                new ItemLoot("Fries", 0.25),
                new ItemLoot("Great Taco", 0.125),
                new ItemLoot("Power Pizza", 0.0625),
                new ItemLoot("Chocolate Cream Sandwich Cookie", 0.03125),
                new ItemLoot("Grapes of Wrath", 0.015625),
                new ItemLoot("Superburger", 0.0078125),
                new ItemLoot("Double Cheeseburger Deluxe", 0.00390625),
                new ItemLoot("Ambrosia", 0.001953125) //xDDDDD
                )
            )
        .Init("Unicorn",
            new State(
