                    ...
                    new State("spawnminions1",
                      ...
                      new State("checkprotectors",
                       ...
                       .Init("Treasure Oryx Defender",
                            new State(
                                new Orbit(5, 2, acquireRange: 10, target: null, speedVariance: null, radiusVariance: null),
                                new Shoot(10, count: 7, projectileIndex: 0, fixedAngle: fixedAngle_RingAttack2)
                                ))
                        .Init("Gold Planet",
                              new State(
                                   new Orbit(5, 8, acquireRange: 10, target: null, speedVariance: null, radiusVariance: null)
                                ));
    }
}